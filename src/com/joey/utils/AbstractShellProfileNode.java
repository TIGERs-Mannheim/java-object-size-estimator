...
/**
 * Abstract base class for all shell pseudo-node implementations in this
 * package. It is used primarily to lower memory consumption by shell nodes.
 * 
 * @author (C) <a
...
abstract class AbstractShellProfileNode extends AbstractProfileNode {
  ...
  public final boolean traverse(final INodeFilter filter,

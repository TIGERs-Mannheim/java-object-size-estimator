...
final class ObjectShellProfileNode extends AbstractShellProfileNode {
  ...
  public String name() {
    return "<shell: " + m_primitiveFieldCount + " prim/" + m_refFieldCount
        + " ref fields>";
  }

  ObjectShellProfileNode(final IObjectProfileNode parent,
      final int primitiveFieldCount, final int refFieldCount) {
    super(parent);

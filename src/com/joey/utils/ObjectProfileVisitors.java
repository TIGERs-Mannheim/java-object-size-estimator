...
public abstract class ObjectProfileVisitors {
   ...
   *          'true' causes all class names to be dumped in compact [no package
   *          prefix] form
   */
  public static ObjectProfileNode.INodeVisitor newDefaultNodePrinter(
      final PrintWriter out, final String indent, final DecimalFormat format,
   ...
   *          prefix] form
   */
  public static ObjectProfileNode.INodeVisitor newXMLNodePrinter(
      final OutputStream out, final String indent, final DecimalFormat format,
      final boolean shortClassNames) {
   ...
   */
  private static final class DefaultNodePrinter extends
      AbstractProfileNodeVisitor {
    public void previsit(final IObjectProfileNode node) {
      ...
      {
        sb.append(" : ");
        sb.append(ObjectProfiler.typeName(node.object().getClass(),
            m_shortClassNames));
    ...
    DefaultNodePrinter(final PrintWriter out, final String indent,
  ...
  private static final class XMLNodePrinter extends AbstractProfileNodeVisitor {
    public void previsit(final IObjectProfileNode node) {
      ...
      if (node.object() != null) // skip shell pseudo-nodes
      {
        ...
        XMLEscape(ObjectProfiler.typeName(node.object().getClass(),
            m_shortClassNames), sb);
        sb.append('\"');
    ...
    XMLNodePrinter(final OutputStream out, final String indent,
        final DecimalFormat format, final boolean shortClassNames) {
      assert out != null : "null input: out";
